...
required_files=(
  ...
  "core_experiments/reproduce/reproduce_public_westermo_validation.sh"
  "core_experiments/reproduce/reproduce_public_westermo_sign_flip_validation.sh"
  "core_experiments/reproduce/reproduce_public_litnet2020_udp_validation.sh"
  "core_experiments/reproduce/reproduce_public_litnet2020_udp_sign_flip_validation.sh"
  "core_experiments/reproduce/reproduce_public_adaptive_matched_validation.sh"
  "core_experiments/reproduce/reproduce_public_adaptive_full_matrix_validation.sh"
  "core_experiments/reproduce/reproduce_public_cabench_scenario_h_attack_extension.sh"
  "core_experiments/reproduce/reproduce_cross_dataset_frontier_summary.sh"
  "core_experiments/reproduce/reproduce_public_server_runtime_benchmark.sh"
  "core_experiments/reproduce/reproduce_public_server_runtime_scaling.sh"
  "core_experiments/reproduce/reproduce_public_server_deployment_runtime_package.sh"
