...
for cfg in \
  ...
  core_experiments/configs_hitrust/public_nslkdd_arc_mean_sage_update_noise_frac0p4_keepall.json \
...
for prefix in \
  ...
  public_nslkdd_arc_mean_sage_update_noise_frac0p4_keepall \
