...
for cfg in \
  ...
  core_experiments/configs_hitrust/public_cabench_scenario_h_caf_sage_update_noise_frac0p4_keepall.json \
  core_experiments/configs_hitrust/public_cabench_scenario_h_centered_clipping_sage_update_noise_frac0p4_keepall.json \
  core_experiments/configs_hitrust/public_cabench_scenario_h_arc_mean_sage_update_noise_frac0p4_keepall.json \
...
for prefix in \
  ...
  public_cabench_scenario_h_caf_sage_update_noise_frac0p4_keepall \
  public_cabench_scenario_h_centered_clipping_sage_update_noise_frac0p4_keepall \
  public_cabench_scenario_h_arc_mean_sage_update_noise_frac0p4_keepall \
